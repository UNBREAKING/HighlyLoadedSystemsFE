...
### Работа с гитом
1. Никто без Алексея Пасейшвили не пушит в мастер, все мы проходим код ревью,
2. когда над чем-то работаем всегда создаем ветку: feature/name-of-branch
3. branchуемся всегда от master
4. перед тем как сделать пуш в ветку, всегда делаем rebase master, вдруг прилетели изменения и это избавит вас от конфликтов при мерже.
5. 1 фича - 1 коммит.
